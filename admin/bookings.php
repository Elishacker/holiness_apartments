...
$sql = "SELECT * FROM Bookings LIMIT $limit OFFSET $offset";
...
<head>
  ...
  <title>Holiness | Booking  Orders</title>
    ...
    <div class="container mt-4">
        ...
        <div class="row mb-3 d-flex align-items-center justify-content-center text-center">
            ...
            <div class="address col-12 text-center mt-2">
                <h5>P.O Box 2776, DODOMA | BOOKING ORDERS</h5><br><br>
            </div>
        </div>
        <table class="table table-bordered table-centered">
            <thead>
                <tr>
                    <th width="25px">Booking ID</th>
                    <th width="25px">Customer ID</th>
                    <th width="20px">Date From</th>
                    <th width="20px">Date To</th>
                    <th width="30px">Amount Paid</th>
                </tr>
            </thead>
            <tbody>
