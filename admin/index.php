    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        ...
        <ul id="forms-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          <li>
            <a href="week_report.php">
              <i class="bi bi-circle"></i><span>Weekly</span>
            </a>
          </li>
          <li>
            <a href="month_report.php">
                ...
                <div class="card-body">
                  ...
                  <div class="d-flex align-items-center">
                    <div class="card-icon rounded-circle d-flex align-items-center justify-content-center">
                      <a href="registered.php"><i class="bi bi-people"></i></a>
                    </div>
                    <div class="ps-3">
                      <h6>
            ...
            <div class="col-xxl-4 col-md-6">
              <div class="card info-card revenue-card">
                ...
                <div class="card-body">
                  ...
                  <div class="d-flex align-items-center">
                    <div class="card-icon rounded-circle d-flex align-items-center justify-content-center">
                      <a href="signed_out.php"><i class="bi bi-people"></i></a>
                    </div>
                    <div class="ps-3">
                      <h6>
                      </h6>
            ...
            <div class="col-xxl-4 col-xl-12">
              ...
              <div class="card info-card customers-card">
                ...
                <div class="card-body">
                  ...
                  <div class="d-flex align-items-center">
                    <div class="card-icon rounded-circle d-flex align-items-center justify-content-center">
                      <a href="payments.php"><i class="bi bi-currency-dollar"></i></a>
                    </div>
                    <div class="ps-3">
                      <h6>
